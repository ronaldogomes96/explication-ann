...
def create_metrics(dataset_name):
    return {
        ...
        'accumulated_time_with_box': [],
        'accumulated_time_without_box': [],
        'accumulated_time_with_box_and_optimization': [],
        'accumulated_box_time': 0,
        'accumulated_optimization_time': 0,
        'accumulated_solver_time_without_optimization': [],
        'accumulated_solver_time_with_optimization': [],
...
def prepare_metrics(metrics, number_executions, len_x):
    ...
    return {
        'avg_time_with_box': np.mean(metrics['accumulated_time_with_box']),
        'std_time_with_box': np.std(metrics['accumulated_time_with_box']),
        'avg_time_without_box': np.mean(metrics['accumulated_time_without_box']),
        'std_time_without_box': np.std(metrics['accumulated_time_without_box']),
        'avg_time_with_box_and_optimization': np.mean(metrics['accumulated_time_with_box_and_optimization']),
        'std_time_with_box_and_optimization': np.std(metrics['accumulated_time_with_box_and_optimization']),
        'avg_time_box': metrics['accumulated_box_time'] / number_explications,
        'avg_time_solver_without_optimization': np.mean(metrics['accumulated_solver_time_without_optimization']),
        'std_time_solver_without_optimization': np.std(metrics['accumulated_solver_time_without_optimization']),
        'avg_time_solver_with_optimization': np.mean(metrics['accumulated_solver_time_with_optimization']),
        'std_time_solver_with_optimization': np.std(metrics['accumulated_solver_time_with_optimization']),
...
def log_metrics(metrics):
    ...
    std_time_with_box = metrics['std_time_with_box']
    std_time_without_box = metrics['std_time_without_box']
    std_time_optimization = metrics['std_time_with_box_and_optimization']
    std_time_solver_without_optimization = metrics['std_time_solver_without_optimization']
    std_time_solver_with_optimization = metrics['std_time_solver_with_optimization']

    logging.info('--------------------------------------------------------------------------------')
    logging.info('METRICS PER EXPLICATION:'
                 f'\n- Average time without box: {avg_time_without_box:.4f} seconds - std +- {std_time_with_box:.4f}'
                 f'\n- Average time with box: {avg_time_with_box:.4f} seconds - std +- {std_time_without_box:.4f}'
                 f'\n- Average time with box and optimization: {avg_time_optimization:.4f} - std +- {std_time_optimization:.4f} seconds'
                 '\nBOX METRICS:'
                 ...
                 f'\n- Average time for solver without optimization: {avg_time_solver_without_optimization:.4f} seconds - std +- {std_time_solver_without_optimization:.4f}'
                 f'\n- Average time for solver with optimization: {avg_time_solver_with_optimization:.4f} seconds - std +- {std_time_solver_with_optimization:.4f}'
